...
namespace Repositories.Migrations
{
    ...
    [Migration("20250214202120_InitalCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppClaimAppRoleClaim", b =>
                {
                    b.Property<int>("AppClaimsId")
                        .HasColumnType("int");

                    b.Property<int>("AppRoleClaimsId")
                        .HasColumnType("int");

                    b.HasKey("AppClaimsId", "AppRoleClaimsId");

                    b.HasIndex("AppRoleClaimsId");

                    b.ToTable("AppClaimAppRoleClaim");
                });

            modelBuilder.Entity("AppRoleAppRoleClaim", b =>
                {
                    b.Property<int>("AppRoleClaimsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AppRoleClaimsId", "AppRolesId");

                    b.HasIndex("AppRolesId");

                    b.ToTable("AppRoleAppRoleClaim");
                });
            ...
            modelBuilder.Entity("AppClaimAppRoleClaim", b =>
                {
                    b.HasOne("Entities.Concrete.AppEntities.AppClaim", null)
                        .WithMany()
                        .HasForeignKey("AppClaimsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.Concrete.AppEntities.AppRoleClaim", null)
                        .WithMany()
                        .HasForeignKey("AppRoleClaimsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AppRoleAppRoleClaim", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Concrete.AppEntities.AppRole", null)
                        .WithMany()
